...
\begin{enumerate}
    \item Background (Jacob edit/review; Shawn)
    \begin{enumerate}
        \item What Are Restricted Environments?
        \item What Are Their Purpose?
        \begin{enumerate}
            \item Common controls for restricted environments
            \item Requirements Localized for Deployments
        \end{enumerate}
        \item Restrictions and limitations in adhering to controls and requirements
    \end{enumerate}
    \item Methodologies 
    \begin{enumerate}
        \item How Exploratory Data Analysis Usually Works (Jacob)
        \begin{enumerate}
            \item             Popular Data Science Ecosystems
            \item             Software development processes
        \end{enumerate}
        \item How Software Development Usually Works (Jacob)
        \item What is a Network Study and how are they done? (Jacob)
        \item Contrast general methods with limitations imposed by restricted environments (Shawn)
        \begin{enumerate}
            \item Challenges with existing workflows
            \item ...
        \end{enumerate}
    \end{enumerate}
    \item Recommendations and Best Practices for Analysis and Developments
    \begin{enumerate}
        \item System Administration to Enforce Proper Operations and Compliance (Shawn)
        \begin{enumerate}
            \item ...
        \end{enumerate}
        \item Researcher compliance (Jacob/Shawn)
        \begin{enumerate}
            \item Popular Data Science Ecosystems within a Restricted Environment
            \item Software development processes within a Restricted Environment
        \end{enumerate}
    \end{enumerate}
    \item Discussion
    \item Conclusion
    \item Appendix
    \begin{enumerate}
        \item Georgia Tech PHDI 
        \begin{enumerate}
            \item Infrastructure set-up
